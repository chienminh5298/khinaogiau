        ...
        <div className="container">
            <div>
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            {XRPdautu} XRP về việt nam: <strong>{parseInt(XRPdautu * currentPrice.XRP) - 16920}</strong>, hôm nay <strong>{convertToUSDCurrency((currentPrice.XRP - openPrice.XRP) * XRPdautu)}</strong>
                            {" tương đương "}
